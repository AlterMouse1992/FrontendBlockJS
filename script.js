...
// (((Переменные a, b и c уже были созданы, поэтому я не создаю их снова, т к выводится ошибка, я их перезаписываю)))
...
console.log("Привет, " + name + "!"); // Не поняла, почему name перечеркнуто. Видимо, косякнула, но пока не знаю, как исправить
